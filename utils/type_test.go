...
import (
	...
	"github.com/limpo1989/go-spring/utils/testdata"
	pkg1 "github.com/limpo1989/go-spring/utils/testdata/pkg/bar"
	pkg2 "github.com/limpo1989/go-spring/utils/testdata/pkg/foo"
)

type SamePkg struct{}

func (p *SamePkg) Package() {
	fmt.Println("github.com/limpo1989/go-spring/utils/utils.SamePkg")
}
...
func TestPkgPath(t *testing.T) {
	...
	data := []struct {
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/limpo1989/go-spring/utils/testdata/pkg/bar",
		},
		{
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/limpo1989/go-spring/utils/testdata/pkg/foo",
		},
		{
...
func TestTypeName(t *testing.T) {
	...
	data := map[interface{}]struct {
		...
		pkg1.SamePkg{}:                             {"github.com/limpo1989/go-spring/utils/testdata/pkg/bar/pkg.SamePkg", "pkg.SamePkg"},
		new(pkg1.SamePkg):                          {"github.com/limpo1989/go-spring/utils/testdata/pkg/bar/pkg.SamePkg", "*pkg.SamePkg"},
		reflect.TypeOf(make([]pkg1.SamePkg, 0)):    {"github.com/limpo1989/go-spring/utils/testdata/pkg/bar/pkg.SamePkg", "[]pkg.SamePkg"},
		reflect.TypeOf(&[]pkg1.SamePkg{}):          {"github.com/limpo1989/go-spring/utils/testdata/pkg/bar/pkg.SamePkg", "*[]pkg.SamePkg"},
		reflect.TypeOf(make(map[int]pkg1.SamePkg)): {"map[int]pkg.SamePkg", "map[int]pkg.SamePkg"},

		pkg2.SamePkg{}:                             {"github.com/limpo1989/go-spring/utils/testdata/pkg/foo/pkg.SamePkg", "pkg.SamePkg"},
		new(pkg2.SamePkg):                          {"github.com/limpo1989/go-spring/utils/testdata/pkg/foo/pkg.SamePkg", "*pkg.SamePkg"},
		reflect.TypeOf(make([]pkg2.SamePkg, 0)):    {"github.com/limpo1989/go-spring/utils/testdata/pkg/foo/pkg.SamePkg", "[]pkg.SamePkg"},
		reflect.TypeOf(&[]pkg2.SamePkg{}):          {"github.com/limpo1989/go-spring/utils/testdata/pkg/foo/pkg.SamePkg", "*[]pkg.SamePkg"},
		reflect.TypeOf(make(map[int]pkg2.SamePkg)): {"map[int]pkg.SamePkg", "map[int]pkg.SamePkg"},

		SamePkg{}:                             {"github.com/limpo1989/go-spring/utils/utils.SamePkg", "utils.SamePkg"},
		new(SamePkg):                          {"github.com/limpo1989/go-spring/utils/utils.SamePkg", "*utils.SamePkg"},
		reflect.TypeOf(make([]SamePkg, 0)):    {"github.com/limpo1989/go-spring/utils/utils.SamePkg", "[]utils.SamePkg"},
		reflect.TypeOf(&[]SamePkg{}):          {"github.com/limpo1989/go-spring/utils/utils.SamePkg", "*[]utils.SamePkg"},
